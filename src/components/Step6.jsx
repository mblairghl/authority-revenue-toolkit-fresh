      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="mb-8">
          <div className="text-center mb-4">
            <span className="text-sm font-medium text-gray-500 uppercase tracking-wide">STEP 6 OF 9</span>
          </div>
          <h1 className="text-3xl font-bold text-gray-900 mb-2">{stepTitles[6]}</h1>
          <p className="text-gray-600">{stepDescriptions[6]}</p>
        </div>
            ...
            <div className="max-w-4xl mx-auto">
              <div className="bg-white rounded-lg shadow-lg border border-gray-200 p-8">
                <div className="text-center mb-8">
                  <h3 className="text-3xl font-bold text-gray-900 mb-4">🎉 Step 6 Complete!</h3>
                  <div className="w-16 h-16 bg-green-500 rounded-full flex items-center justify-center mx-auto mb-4">
                    <span className="text-white text-2xl">✓</span>
                  </div>
                  <p className="text-xl text-gray-700">Congratulations on completing {stepTitles[6]}!</p>
                </div>

                <div className="bg-orange-50 border border-orange-200 rounded-lg p-6 text-center">
                  <h4 className="text-lg font-semibold text-orange-900 mb-2">🎊 Milestone Achieved!</h4>
                  <p className="text-orange-800">
                    You've successfully completed Step 6 of your Authority Revenue Toolkit!
                  </p>
                </div>
              </div>
            </div>
        ...
        <div className="mt-12 bg-white rounded-lg shadow-lg border border-gray-200 p-6">
          <div className="flex flex-col lg:flex-row justify-between items-center space-y-4 lg:space-y-0">
            ...
            >
              <span>← Back to Step $((6 - 1))</span>
            </a>
            
            {activeSubStep === 2 ? (
              $(6 < 9 ? "<a href=\"/step/$((6 + 1))\" className=\"text-white px-6 py-3 rounded-lg font-medium transition-colors flex items-center justify-center space-x-2 text-center bg-orange-500 hover:bg-orange-600\"><span>Continue To Step $((6 + 1)) →</span></a>" : "<a href=\"/dashboard\" className=\"text-white px-6 py-3 rounded-lg font-medium transition-colors flex items-center justify-center space-x-2 text-center bg-green-500 hover:bg-green-600\"><span>Return to Dashboard</span></a>")
            ) : (
